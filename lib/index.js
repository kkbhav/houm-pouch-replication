...
function toPouch(db, opts) {
  ...
  } else if (typeof db === 'object' && (db.url || db.name) && !(db instanceof PouchConstructor)) {
  	var newObj = Object.assign({}, db, opts);
  	var name = db.name || db.url;
  	return new PouchConstructor(name, newObj);
  } else {
    return db;
  }
}
